...
@section('content')
    ...
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            ...
            <form method="GET" action="{{ route('expense-categories.index') }}" class="row g-2 mb-3">
                <div class="col-md-5">
                ...
                <div class="col-md-4">
                    <button type="submit" class="btn btn-outline-secondary"><i class="bi bi-search me-1"></i>
                        Filter</button>
                    <a href="{{ route('expense-categories.index') }}" class="btn btn-outline-secondary">Reset</a>
                </div>
            </form>
                    ...
                    <tbody>
                        @forelse ($categories as $category)
                            <tr>
                                ...
                                <td><span class="badge text-bg-light text-dark">{{ $category->expenses_count }}</span></td>
                                <td>
                                    <span
